...
|---|---|---|
| Title | ✅ | Short, action-oriented (e.g., "Add user registration endpoint") |
...
| Labels | ✅ | `frontend`, `backend`, `devops`, `bug`, `tech-debt` |
...
- [ ] Feature is deployed to the `dev` environment.
- [ ] Acceptance criteria are verified by QA or BA.
- [ ] Documentation is updated (API docs, README, ADRs if applicable).
